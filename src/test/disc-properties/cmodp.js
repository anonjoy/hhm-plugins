...
const getOriginalPlayerDiscProperties = (TEAM) => ORIGINAL_PLAYER_DISC_PROPERTIES[TEAM]; // return Object reference
const getOriginalBallProperties       = () => ORIGINAL_BALL_PROPERTIES; // return Object reference
